...
input_image = imread('QS crop.jpg');
...
image_vect = input_image(25,:);
image_squared = image_vect.^2; %Formula for autocorrelation
index = 1; %To fill autocorrelation array

for u = 0:100 %Range of u-values

    image_transformed = VectorShift(image_vect,u); %Shift elements by u, this is the horizontal transformation
